-- https://docs.astronvim.com/recipes/mappings/#enable-telescope-lsp-mappings
-- This is to add back functionality for go to def to open telescope and not quickfix list
